...
int main()
{
    char name[N][20]={"홍길동", "이몽룡", "성춘향", "제갈공명", "주몽",
                     "배장화", "배홍련", "홍길동", "연흥부", "연놀부"};
    char phone[N][15]= {"010-5210-1234", "010-523-1628",
                        "010-1235-8765", "010-345-1676", "0100-5210-5463",
    ...
    cnt = 0;
    for (i=0; i<N; i++)
       if (strcmp(who, name[i]) == 0)   // who와 name[i]가 같은 문자열이면
       {
           cnt++;
